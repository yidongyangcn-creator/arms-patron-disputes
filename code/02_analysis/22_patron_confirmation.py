...
PANEL=DERIVED/"clean_polrel_panel_1955_2014.csv"

def build_panel():
    """Rebuild the 1955-2014 panel from the raw sources. Only runs when the
    tracked panel is absent; later scripts add columns to that file, so
    rebuilding here would strip them. Delete the file to force a rebuild."""
    # ---------- states ----------
